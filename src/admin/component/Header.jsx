...
const Header = ({ toggleSidebar }) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (dropdownOpen && !event.target.closest(".admin-dropdown")) {
        ...
        <div className="header-start">
          ...
          <div className="logo-container">
            <div className="logo-icon">
              <img src={mblogo} alt="MB Bank Logo" className="logo-image" />
            </div>
            <div className="logo-text">
              <h1 className="admin-title">MB Bank Admin</h1>
              <span className="admin-subtitle">Quản trị hệ thống</span>
            </div>
          </div>
        </div>
